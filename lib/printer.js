...
module.exports.getCutterControl_DNP = getCutterControl_DNP;
...
function getCutterControl_DNP(printerName) {
    if(!printerName) {
        printerName = getDefaultPrinterName()
    }
    
    return printer_helper.getCutterControl_DNP(printerName)
}